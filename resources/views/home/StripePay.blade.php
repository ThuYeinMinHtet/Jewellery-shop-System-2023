...
<div class="hero_area">
 ...
 <span style="font-size:15px;">   @include('home.navbar')  </span>  
<div class="container">
    
    <h1 style="text-align:center; font-size:24px; padding-buttom:14px;"> Pay Using Card --Total Amount {{$totalprice}} MMK</h1>
